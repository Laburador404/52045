...
import Calc52045Visitor from "./generated/Calc52045Visitor.js";
import Calc52045Parser from "./generated/Calc52045Parser.js";

export class CustomCalc52045Visitor extends Calc52045Visitor{
    ...
    visitMulDiv(ctx) {
        ...
        if (ctx.op.type==Calc52045Parser.MUL)
          return left * right;
        else
          return left / right;
      }
      ...
      visitAddSub(ctx) {
        ...
        if (ctx.op.type==Calc52045Parser.ADD){
          return left + right; }
        else
          return left - right;
      }
