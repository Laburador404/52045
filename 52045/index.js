import Calc52045Lexer from "./generated/Calc52045Lexer.js";
import Calc52045Parser from "./generated/Calc52045Parser.js";
import { CustomCalc52045Listener } from "./CustomCalc52045Listener.js";
import { CustomCalc52045Visitor } from "./CustomCalc52045Visitor.js";
...
async function main() {
    ...
    let lexer = new Calc52045Lexer(inputStream);
    let tokenStream = new CommonTokenStream(lexer);
    let parser = new Calc52045Parser(tokenStream);
    ...
    if (parser.syntaxErrorsCount > 0) {
        ...
        //const listener = new CustomCalc52045Listener();
        // ParseTreeWalker.DEFAULT.walk(listener, tree);

        // Utilizo un visitor para visitar los nodos que me interesan de mi arbol
        const visitor = new CustomCalc52045Visitor();
        visitor.visit(tree);   
    }
}
